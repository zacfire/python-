...
if __name__ == '__main__':
    ...
    Login_Data['user_login'] = '574510001@qq.com'
    Login_Data['user_pass'] = 'Bonjourchenyan'
    #使用urlencode方法转换标准格式
    loginpostdata= parse.urlencode(Login_Data).encode('utf-8')
    #声明一个cookiejar对象实例来保存cookie
    cookie=cookiejar.CookieJar()
    #利用urllib.request的HTTPCookieProcessor对象来创建cookie处理器，也就是cookieHandler
    cookie_support = request.HTTPCookieProcessor(cookie)
    #通过cookiehandler来创建opener
